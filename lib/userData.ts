...
export interface Project {
  ...
  location: string
  budget?: number
  status: "draft" | "contractor-review" | "client-review" | "approved" | "in-progress" | "completed"
  clientId: string
  architectId: string
  contractorId?: string
...
export const dummyProjects: Project[] = [
  {
    ...
    description: "High-end residential development with 50 units",
